...
class CreateRecent extends State<Recent> {
  ...
  _getMovements() async {
    ...
    setState(() {
      ...
      print(movementsDataUser.length);
      for(var x=0;x<movementsDataUser.length;x++){
        if(movementsDataUser[x]['type']=='ingreso'){
          movementsDataI.add(movementsDataUser[x]);
        }else{
          movementsDataG.add(movementsDataUser[x]);
        }
      }
    });
  }
